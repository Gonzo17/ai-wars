...
<template>
  <div class="absolute inset-0 z-30 flex items-center justify-center p-8 overflow-hidden">
    ...
    <div
      ...
      class="relative w-full max-w-3xl h-[calc(100vh-16rem)] flex flex-col rounded-lg border border-info-500/30 bg-neutral-900/95 shadow-lg shadow-info-500/10 overflow-hidden"
    >
      <!-- Header -->
